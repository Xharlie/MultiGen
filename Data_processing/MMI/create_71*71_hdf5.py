...
def load():
  ...
  with h5py.File(SOURCE_FOLDER_PREFIX + 'all_info_small.h5', 'w') as f:
  ...
  with open(SOURCE_FOLDER_PREFIX + 'all_info_small.txt', 'w') as f:
    f.write("../../Source/MMI/" + 'all_info_small.h5' + "\n")
